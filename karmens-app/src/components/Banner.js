...
import headerImg from "../assets/img/sailor-saturn.png";
...
export const Banner = () => {
  ...
  const toRotate = [ "Software Engineer.", "Digital Developer."];
  const period = 2000;

  // this is the code for the text on screen 
  useEffect(() => {
...
/*! Tracking the visibility to ensure that our react component is visible on screen for animation purposes with react-on-screen. Added animations with animate css.
